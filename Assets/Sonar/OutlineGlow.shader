...
////// Emissive:
                ...
                float node_8702 = 0.0;
                float node_743 = distance(float2(((_ScreenParams.r/_ScreenParams.g)*sceneUVs.r),sceneUVs.g),_PlayerPos.rgb);
                float3 emissive = (_GlowMul*((_ColorMul.rgb*_OutlineTex_var.rgb)*round(fmod((saturate(floor(((node_743-node_8702)/((_Radius-_Threshold)-node_8702))))+saturate(floor(((node_743-node_8702)/((_Radius+_Threshold)-node_8702))))),2.0))));
