...
////// Emissive:
                ...
                float3 emissive = (_ColorMul.rgb*(_OutlineTex_var.rgb*round(fmod((saturate(floor(((node_743-node_8702)/((_Radius-_Threshold)-node_8702))))+saturate(floor(((node_743-node_8702)/((_Radius+_Threshold)-node_8702))))),2.0))));
